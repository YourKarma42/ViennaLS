#ifndef LS_CURVATURECALCULATOR_HPP
#define LS_CURVATURECALCULATOR_HPP
...
template <class T, int D> class baseCurvature{
    ...
    virtual T getMeanCurvature(hrleCartesianPlaneIterator<hrleDomain<T, D>> & neighborIterator) {return -1;}
...
template <class T, int D> class curvaturGeneralFormula: public baseCurvature<T, D>{
    ...
    T getMeanCurvature(hrleCartesianPlaneIterator<hrleDomain<T, D>> & neighborIterator){
    ...
    */
    bool calcDerivatives(hrleSparseBoxIterator<hrleDomain<T, D>> & neighborIterator){
    ...
    bool calcDerivatives(hrleCartesianPlaneIterator<hrleDomain<T, D>> & neighborIterator){
...
template <class T, int D> class curvaturShapeDerivatives1: public baseCurvature<T, D>{
    ...
    */
    ...
    bool calcDerivatives(hrleConstSparseStarIterator<typename lsDomain<T, D>::DomainType> & neighborIterator){
    ...
    T getMeanCurvature(hrleConstSparseStarIterator<typename lsDomain<T, D>::DomainType> & neighborIterator){
...
template <class T, int D> class variationOfNormals: public baseCurvature<T, D>{
    ...
    */
    ...
    T getGaussianCurvature(hrleCartesianPlaneIterator<hrleDomain<T, D>> & neighborIterator){
...
#endif // LS_CURVATURECALCULATOR_HPP
